...
game.import("card", function () {
	return {
		...
		translate: {
			liulongcanjia: "六龙骖驾",
			liulongcanjia_info: "锁定技，当此牌进入你的装备区时，弃置你装备区里其他坐骑牌。只要此牌在你的装备区里，你的装备区便不能放入其他坐骑牌。你计算与其他角色的距离-1，其他角色计算与你的距离+1。",
			minguangkai: "明光铠",
			...
			feilongduofeng_info: "当你使用【杀】指定角色为目标后，你可以令该角色弃置一张牌。你的【杀】令目标角色进入濒死状态时，你可以获得其一张手牌。",
			taipingyaoshu: "太平要术",
			...
			yuxi_skill2: "玉玺",
			yuxi: "玉玺",
			yuxi_info: "锁定技，若你有已明置的武将牌，你获得以下效果：你的势力成为场上唯一的大势力，其他势力均为小势力；摸牌阶段，你多摸一张牌；出牌阶段开始时，你视为使用一张【知己知彼】。",
			xietianzi: "挟天子以令诸侯",
			xietianzi_info: "出牌阶段，对自己使用。你结束出牌阶段。本回合的弃牌阶段结束时，你可以弃置一张手牌，获得一个额外的回合。",
			xietianzi_info_guozhan: "出牌阶段，若你是大势力角色，对你使用。结束你的出牌阶段，然后若你于弃牌阶段结束时弃置一张手牌，则于此回合结束时，你进行一个额外的回合。",
			shuiyanqijunx: "水淹七军",
			...
			lulitongxin: "勠力同心",
			lulitongxin_info: "出牌阶段，对所有的大势力角色或所有的小势力角色使用。若目标角色处于连环状态，则其摸一张牌；不处于连环状态，则其横置。",
			lulitongxin_info_versus: "出牌阶段，对所有己方角色或所有敌方角色使用。若目标角色：未横置，则其横置；已横置，则其摸一张牌。",
			lianjunshengyan: "联军盛宴",
			lianjunshengyan_info: "出牌阶段，对你和你选择的一个其他势力的所有角色使用，你选择一项：1.回复X点体力；2.摸X张牌。然后其他每名目标角色各摸一张牌并重置其武将牌。（X为该势力存活角色数）",
			lianjunshengyan_info_boss: "出牌阶段，对场上所有角色使用。你摸X张牌（X为存活角色数），其他角色依次选择回复1点体力或摸一张牌。",
			chiling: "敕令",
			chiling_info: "出牌阶段，对所有没有势力的角色使用。每名角色依次选择一项：1.明置一张武将牌，摸一张牌；2.弃置一张装备牌；3.失去1点体力。（若【敕令】因使用以外的效果进入弃牌堆前，则改为将此牌移出游戏，然后在此回合结束前，没有势力的角色依次选择执行敕令的效果。）",
			diaohulishan: "调虎离山",
			diaohulishan_info: "出牌阶段，对至多两名其他角色使用。目标角色于此回合视为移出游戏。",
			huoshaolianying: "火烧连营",
			huoshaolianying_bg: "烧",
			huoshaolianying_info_guozhan: "出牌阶段，对你的下家和所有与其处于同一队列的角色使用。每人受到1点火焰伤害。",
			...
			huxinjing_info_guozhan: "当你受到大于等于你体力值的伤害时，你可以将装备区里的【护心镜】放入弃牌堆防止此伤害。",
