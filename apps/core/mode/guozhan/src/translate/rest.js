...
export default {
  ...
  gz_ol_jiushi: "酒诗",
  gz_ol_jiushi_info:
    "你明置一张武将牌后，若当前回合角色能使用【酒】，你可令其视为使用之。当你受到伤害后，若你的武将牌均明置，你可以重铸任意张梅花牌并暗置此武将牌。",
  gz_ol_zongpei: "纵辔",
  gz_ol_zongpei_info:
    "每回合限一次，当其他角色的牌不因使用而置入弃牌堆后，你可以获得其中的锦囊牌和坐骑牌。",
  gz_ol_sunjun: "OL国战孙峻",
  ...
  gz_ol_zhulian: "诛连",
  gz_ol_zhulian_info:
    "锁定技，你的回合内，于本回合使用过【桃】，或成为过【桃】目标的角色受到的伤害+1。",
  gz_ol_jianshuo: "OL国战蹇硕",
  gz_ol_jianshuo_prefix: "OL国战",
  gz_ol_shantong: "擅统",
  gz_ol_shantong_info:
    "同势力角色的准备阶段，若其武将牌均明置，其可以暗置一张武将牌，令其此回合使用的下一张牌无距离和次数限制。若如此做，此回合其明置该武将牌后，你对其造成1点伤害并获得其所有手牌。",
  gz_ol_qiuchou: "群仇",
  gz_ol_qiuchou_info:
    "锁定技，你杀死一名角色，或同势力角色杀死你的奖惩改为变更暗置的副将。",
  gz_re_lvbu_prefix: "界",
  gzfengpo: "凤魄",
  gzfengpo_info:
