...
const translates = {
  ...
  old_panfeng: "旧潘凤",
  old_panfeng_prefix: "旧",
  oldkuangfu: "狂斧",
  oldkuangfu_info:
    "当你使用【杀】对目标角色造成伤害后，你可以将其装备区里的一张牌移动到你的装备区里或弃置之。",
  ...
  juedi: "绝地",
  juedi_info:
    "准备阶段，若你的武将牌上有“引兵”牌，你可以选择一项：1.移去“引兵”牌，然后摸等量的牌；2.令一名体力值不大于你的其他角色获得“引兵”牌，然后其回复1点体力。",

  old_zhugedan: "旧诸葛诞",
  old_zhugedan_prefix: "旧",
  oldjuyi: "举义",
  oldjuyi_info:
    "觉醒技，准备阶段，若你已受伤且体力上限大于全场角色数，你将手牌摸至体力上限，然后获得〖崩坏〗和〖威重〗。",
  oldweizhong: "威重",
  oldweizhong_info: "锁定技，当你的体力上限变化后，你摸一张牌。",

  old_sunluyu: "旧孙鲁育",
  old_sunluyu_prefix: "旧",
  oldmeibu: "魅步",
  oldmeibu_info:
    "其他角色的出牌阶段开始时，若你不在其攻击范围内，你可以令其的锦囊牌本回合均视为【杀】。若如此做，本回合你视为在其攻击范围内。",
  oldmumu: "穆穆",
  oldmumu_info:
