...
const translates = {
  ...
  jsrgzhenglve: "政略",
  jsrgzhenglve_info:
    "每轮首位角色的回合结束后，你可以摸一张牌，然后令一名没有“猎”的角色获得“猎”（若每轮首位角色本回合未造成过伤害，则改为至多两名）。你对有“猎”的角色使用牌无距离和次数限制。每回合限一次，当你对有“猎”的角色造成伤害后，你可以摸一张牌并获得造成此伤害的牌。",
  jsrgzhenglve_info_identity:
    "主公的回合结束后，你可以摸一张牌，然后令一名没有“猎”的角色获得“猎”（若主公本回合未造成过伤害，则改为至多两名）。你对有“猎”的角色使用牌无距离和次数限制。每回合限一次，当你对有“猎”的角色造成伤害后，你可以摸一张牌并获得造成此伤害的牌。",
  jsrghuilie: "会猎",
  jsrghuilie_info:
    "觉醒技，准备阶段，若有“猎”的角色数大于2，你减1点体力上限，然后获得〖平戎〗和〖飞影〗。",
  jsrgpingrong: "平戎",
  jsrgpingrong_info:
    "每轮限一次，一名角色的回合结束时，你可以弃一名角色的“猎”，然后你于此回合结束后执行一个额外回合。若如此做，该额外回合结束时，若你该回合未造成过伤害，你失去1点体力。",
